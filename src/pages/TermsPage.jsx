      ...
      <footer className="relative z-10 max-w-[1280px] mx-auto px-6 sm:px-10 py-8 border-t border-slate-200 flex flex-col sm:flex-row items-center justify-between gap-3" role="contentinfo">
        ...
        <nav aria-label="Legal navigation">
          <div className="flex items-center gap-4">
            <Link to="/privacy" className="font-poppins text-[13px] text-ink-2 hover:text-ink transition-colors duration-200">
              Privacy Policy
            </Link>
            <Link to="/terms" className="font-poppins text-[13px] text-brand font-medium" aria-current="page">
              Terms &amp; Conditions
            </Link>
          </div>
        </nav>
