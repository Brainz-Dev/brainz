...
function IconSlot({ icon, name }) {
  ...
  return (
    <div className="w-28 h-28 rounded-xl border-2 border-dashed border-white/10 flex items-center justify-center bg-white/[0.02]">
      <svg
        className="w-100 h-100 text-white/20"
        fill="none"
        stroke="currentColor"
        strokeWidth={1.5}
        viewBox="0 0 24 24"
  ...
  return (
    ...
    >
      <div className="flex items-start justify-between gap-3">
        ...
        <span
          className={`flex-shrink-0 text-[11px] font-poppins font-medium px-2.5 py-1 rounded-full border ${badgeClass}`}
        >
          {product.category}
        </span>
      </div>
