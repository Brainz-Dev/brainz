...
function CurrencyTable({ currencies }) {
  ...
  return (
    <div>
      <p className="font-poppins text-[11px] uppercase tracking-widest text-ink-3 mb-2">
        Pricing by currency
      </p>
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-2">
        {currencies.map((c) => (
          ...
          >
            <span className="font-poppins text-[11px] font-semibold text-ink-3">
              {c.code}
            </span>
        ...
        {pricing.map((plan) => (
          ...
          >
            ...
            <div className="flex items-center justify-between flex-wrap gap-2">
              <span className="font-poppins font-semibold text-ink text-[15px]">
                {plan.tier}
              </span>
              {plan.pricingMethod && (
            ...
            <div>
              ...
              {plan.pricingMethodNote && (
                <p className="font-poppins text-[12px] text-ink-3 mt-1.5 flex items-start gap-1.5">
                  <svg
                    className="w-3.5 h-3.5 text-violet-500 flex-shrink-0 mt-0.5"
                    fill="none"
                    stroke="currentColor"
                    strokeWidth={2}
                    viewBox="0 0 24 24"
              ...
              {plan.description && (
                <p className="font-poppins text-[13px] text-ink-2 mt-2">
                  {plan.description}
                </p>
              )}
            </div>
            ...
            {plan.cta && (
              <a
                href={
                  plan.ctaHref ??
                  "https://www.freshworks.com/apps/insight_lens_1/"
                }
                target="_blank"
